...
Utilisez des [formats de fichiers appropriés, ouverts et accessibles]{style="color:green;"} [(lien)](https://osf.io/ena5p) pour améliorer l’accessibilité :
...
:::: {#Second-column}
::: {style="text-align: center;font-size: 50%"}
![Arborescence des dossiers](images/output.png){fig-alt="Une capture d'écran d'un répertoire structuré contenant des figures/tracés scientifiques" width="100%"}
:::
::::
:::::
