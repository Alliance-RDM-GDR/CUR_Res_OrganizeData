...
format: 
  ...
  revealjs:
    footer: "Handling and organizing research data - FRDR curation team"
...
## Make datasets understandable {.center} 

:::::{layout-ncol="2" layout-valign="center"}
::::{#first-column}
:::{style="text-align: left;font-size: 80%"}
Research data comes in many flavors and shapes ([tables]{style="color:orange;"}, [images]{style="color:magenta;"}, [videos]{style="color:red;"}, [text]{style="color:gray;"}).
...
Use [comprehensive metadata]{style="color:green;"} (README files and data dictionaries/codebooks) to [contextualize]{style="text-decoration: underline;"} and [describe]{style="text-decoration: underline;"} research files.
...
## {{< bi file-earmark-spreadsheet>}} Tables are the core of research data {.center}
...
## Examples from [Crystal Lewis (2024)](https://datamgmtinedresearch.com/){.center}
...
## {{< bi file-earmark-spreadsheet>}} Wide table formats{.center}
...
## {{< bi file-earmark-spreadsheet>}} Long table formats {.center}
...
In a [long format]{style="color:green;"} table, the observations per [subject]{style="text-decoration: underline;"} occupy [various rows]{style="color:green;"}: [subject]{style="color:orange;"}(repeat), [Time (1, 2 , 3)]{style="color:magenta;"}.
:::

::: {.callout-tip .smaller}
Useful when analyzing [time-lapse data]{style="color:green;"}. [Example:]{style="text-decoration: underline;"}   
...
:::: {#first-column}
::: {style="text-align: left;font-size: 80%"} 
- Datasets are [unintelligible]{style="color:red;"} if they are not accompanied by a [README file]{style="color:green;"} [(.txt, .md)]{style="color:green;"} that describes their [context and content]{style="color:green;"}. [Codebooks and data dictionaries]{style="text-decoration: underline;"} [(.txt, .md, .csv)]{style="color:green;"} are also useful for describing the [variables]{style="color:green;"} in each data table.  
:::
::::
...
- {{< bi gear-fill>}} Share [technical]{style="color:green;"} (acquisition parameters) and [descriptive]{style="color:green;"} (context and content) [metadata]{style="color:green;"}.
...
Export technical metadata from proprietary images (i.e .czi) as [.txt or .csv]{style="color:green;"} files.  
...
Document the [provenance and naming conventions]{style="color:green;"} in README files.
...
## A worrying research landscape{.center} 
...
- (Optional) Include [Data_Appendix]{style="color:green;"} files showing basic descriptive statistics or data distributions.
...
A [Data_Intermediate]{style="color:orange;"} folder can contain intermediate or pre-processed files (i.e. image 'masks' or machine learning classifiers) as part of an analysis pipeline. 


## {{< bi code-square >}} Scripting is the way 

::: {style="text-align: left;font-size: 80%"}
While most researchers may be more comfortable with GUIs, the current research landscape requires the use of [scripts and code]{style="color:green;"} to ensure reproducible research results.
:::
...
:::: {#second-column}
:::{style="text-align: left;font-size: 70%"}
With [GitHub](https://github.com/) {{< bi github>}}  or [GitLab](https://about.gitlab.com/) {{< bi gitlab>}} you can:
...
- {{< bi folder-plus>}} [Link/render]{style="color:green;"} your code in different platforms (i.e [OSF](https://osf.io/)) or [Borealis](https://borealisdata.ca/). 
...
:::: {#Second-column}
::: {style="text-align: center;font-size: 50%"}
![Folder tree](images/output.png){fig-alt="A screenshot of a structured directory containing research figures/plots" width="100%"}
:::
::::
:::::
